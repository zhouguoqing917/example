...
public class WebResourceReader {
	...
	private static final Log log = LogFactory.getLog(WebResourceReader.class);
...
//			System.out.println(buffer.toString());
	...
	public static void main(String[] args) {
		String url;
		try {
			url = "http://api.tv.sohu.com/boke/video/info/28399502.json?api_key=4a62c00db90213d0f54115e0b3ab5535";
...
//		System.out.println(WebResourceReader.read("http://tv.sohu.com/frag/309638526/112712_309638526.inc"));
		...
		System.out.println(URLEncoder.encode("电影", "UTF-8"));
